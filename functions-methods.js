...
function checkCumLaude(gradesList) {
...
// Dit had ik hierboven al gedaan. Ik had dan nog 'gradesList' kunnen vervangen voor 'numbersArray' oid. Bij dezen
// nog de twee overige verwachte uitkomsten:
console.log(checkCumLaude([6, 4, 5]))
console.log(checkCumLaude([8, 9, 4, 5, 10]))
...
function calculateMean(gradesList) {
    let sumGrades = 0
    for (let i = 0; i < gradesList.length; i++) {
...
console.log(calculateMean(grades))
...
console.log(calculateMean([4, 5, 6]))
console.log(calculateMean([8, 9, 4, 6, 10]))

/* 2c: Afronden op twee decimalen */
// Zorg ervoor dat het gemiddelde cijfer dat wordt teruggegeven uit de functie netjes wordt afgerond op twee decimalen.
// Tip: Google is your best friend!

function calculateMeanRound(gradesList) {
    let sumGrades = 0
    for (let i = 0; i < gradesList.length; i++) {
        sumGrades += gradesList[i]
    }
    const mean = sumGrades / gradesList.length
    return mean.toFixed(2)
}

console.log(calculateMeanRound(grades))
...
console.log(getHighestNumber(grades))
console.log(getHighestNumber([6, 4, 5]))
console.log(getHighestNumber([8, 9, 4, 6, 10]))
